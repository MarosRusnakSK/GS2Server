...
namespace GS2.Server.Alignment
{
    public static class AlignmentSettings
    {
        ...
        private static GS2.Server.Alignment.AlignmentBehaviourEnum _alignmentBehaviour;
        public static GS2.Server.Alignment.AlignmentBehaviourEnum AlignmentBehaviour
        {
