...
namespace GS2.Server.AutoHome
{
    public class AutoHomeSky
    {
        ...
        private static void HomeSensorCapabilityCheck()
        {
            ...
            bool.TryParse(Convert.ToString(SkyQueueGS2.GetCommandResult(canHomeSky).Result), out bool hasHome);
        ...
        {
            var sensorStatusSky = new SkyGetHomePosition(SkyQueueGS2.NewId, axis);
            var sensorStatus = (long)SkyQueueGS2.GetCommandResult(sensorStatusSky).Result;
        ...
        {
            var reset = new SkySetHomePositionIndex(SkyQueueGS2.NewId, axis);
            //var _ = (long)SkyQueueGS2.GetCommandResult(reset).Result;
        ...
        private AutoHomeResult SlewToHome(AxisId axis)
        {
            ...
            var skyCmd = new SkyGetStepToAngle(SkyQueueGS2.NewId, axis, a);
            var b = (double)SkyQueueGS2.GetCommandResult(skyCmd).Result;
