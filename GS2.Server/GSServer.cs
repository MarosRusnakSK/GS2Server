...
namespace GS2.Server
{
    public static class GSServer
    {
        ...
        private const string SAppId = "{D5739B8E-0B1F-48F7-BD06-FF53E9812FE5}"; // Our AppId
        // private const string SImplementedCategory = "{5F2A3C41-7FBC-41A3-A04C-31CA94D06407}"; // Our Implemented Category ID
        private const string SImplementedCategory = "{80D32E30-3574-4EBC-8A9A-6E758F87407D}"; // Our Implemented Category ID
        private static readonly object LockObject = new object();
        private static bool _removeProfile;
        private static BackgroundWorker _bgWorker;
        private const string DriverName = "ASCOM.GS2.Sky.Telescope.dll";
        private const string ApiName = "GS2.SkyApi.dll";
                ...
                try
                {
                    ...
                    using (var key = Registry.ClassesRoot.CreateSubKey($"CLSID\\{clsid}"))
                    {
                        if (key != null)
                        {
                            ...
                            {
                                // GUID_GS2
                                key2?.CreateSubKey(SImplementedCategory);
                            }
        ...
        private static void UnRegisterObjects()
        {
            ...
            foreach (Type type in _comObjectTypes)
            {
                ...
                //
                Registry.ClassesRoot.DeleteSubKey(
                    $"CLSID\\{clsid}\\Implemented Categories\\{SImplementedCategory}", false);
