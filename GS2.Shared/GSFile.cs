...
namespace GS2.Shared
{
    public static class GsFile
    {
        ...
        {
            //GUID_GS2
            Settings.LogPath = Directory.Exists(path) ? path : Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "GS2Server");
        }
        /// <summary>
        ...
        public static string GetLogPath()
        {
            ...
            return Directory.Exists(path) ? path : Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments),"GS2Server");
        }
        /// <summary>
