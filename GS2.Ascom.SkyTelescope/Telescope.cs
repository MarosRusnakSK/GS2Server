...
namespace ASCOM.GS2.Sky.Telescope
{
    ...
    [Guid("71DCBACD-91D9-4AF3-B564-E2F51F1D00D0")]
    [ServedClassName("ASCOM GS2 Sky Telescope")]
    [ProgId("ASCOM.GS2.Sky.Telescope")]
    ...
    public sealed class Telescope : ObjectBase, ITelescopeV4, IDisposable
    {
        ...
        public string Action(string actionName, string actionParameters)
        {
            ...
            switch (actionName)
            {
                ...
                // NONE: MRXXX: Implement TrackingAtDisconnect action
        ...
        public ArrayList SupportedActions
        {
            ...
            get
            {
                ...
                // ReSharper disable once StringLiteralTypo
                // var sa = new ArrayList { @"Telescope:SetParkPosition", @"Telescope:TrackingAtDisconnect" };
